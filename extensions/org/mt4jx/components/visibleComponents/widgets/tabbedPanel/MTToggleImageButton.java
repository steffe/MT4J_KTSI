...
public class MTToggleImageButton extends MTImageButton {
	...
	public MTToggleImageButton(PApplet pApplet, PImage texture){
		super(pApplet, texture);
		this.setName("Unnamed Toggle Button");
		this.selfRef = this;
		this.overlayButton = new MTImageButton(pApplet, texture);
		...
		//this.overlayButton.addGestureListener(TapProcessor.class, new IGestureEventListener());
		this.overlayButton.addGestureListener(TapProcessor.class, new IGestureEventListener() {
