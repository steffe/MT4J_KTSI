...
public class BkpOfMyMTObject extends MTComponent{
	...
	public BkpOfMyMTObject(MTApplication pApplet_2, int id_2)  {
		super (pApplet_2);
		pApplet=pApplet_2;
		this.id = id_2;
	...
	//	infobox.setSizeLocal(50, 140);
		...
		// Testattribut 
		p1 = new MTNumField(pApplet,fontArialMini,200,40,true,"1","TestFeld",fontArial);
